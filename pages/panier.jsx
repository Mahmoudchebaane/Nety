...
export default function Panier() {
  ...
  const deletProductFromPanier = (productId) => {
    ...
    totalPrice = productsAfterDeletion.reduce(
      (acc, currProd) => acc + ((currProd.remise ? currProd.remise : currProd.prix)*currProd.qte),
      0
    );
    setTotalPrice(totalPrice);
...
const router = useRouter();
  ...
  return (
    <>
      <Header />
      <div className="p-3">icone + Panier</div>
          ...
          <div className="col-md-4 req-cmd">
            <div className="bg-detail-product p-3 d-flex flex-column shadow mb-5 rounded">
              ...
              <div className="row justify-content-center pt-4">
                ...
                <button onClick={totalPrice !== 0 ? handleChangeCommande : null} className="btn btn-modal-panier">Commander</button>
